...
Scene::Scene(const std::shared_ptr<Camera> &camera_arg) {
...
Scene::Scene(const std::vector<std::shared_ptr<Camera>> &cameras_arg, const unsigned int activeCamera_arg =0) {
